...
#define pkgversion_string "(Arm GNU Toolchain 12.2.rel1 (build-tools-gcc r320-g6cdd090e)) "
...
#define bug_report_url "<https://github.com/krasCGQ/build-tools-gcc/issues>"
